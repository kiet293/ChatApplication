...
public class MainScreen extends JFrame implements ActionListener {
	...
	public MainScreen() {
		...
		groupListScrollPane.setBorder(BorderFactory.createTitledBorder("Group list"));
		...
		roomUsersJList.setBorder(BorderFactory.createTitledBorder("User in the current room"));
		...
		this.setTitle("Chat apps log in with your name " + Main.socketController.userName);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "group": {
			...
			onlineUserScrollPanel.setBorder(BorderFactory.createTitledBorder("Select a user to add to the group"));
			...
			createButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (groupName.isEmpty()) {
						JOptionPane.showMessageDialog(chooseUserDialog, "The group name must not be blank", "Group creation error",
					...
					if (chosenUsers.size() < 2) {
						JOptionPane.showMessageDialog(chooseUserDialog,
								"Group must have 3 or more people (choose 2 or more people)", "Group creation error",
								JOptionPane.WARNING_MESSAGE);
						return;
					}
			...
			chooseUserDialog.setTitle("Create new a group");
